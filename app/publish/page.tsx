...
import { MAX_PUBLISH_IMAGES, publishDraftToAnnouncement, removePublishAttachment, selectPublishImages, setPrimaryLink, validateBasicDraft, type BasicAnnouncementDraft, type DraftErrors, type PublishImageAttachment, type PublishPdfAttachment } from "@/lib/publishDraft";
...
const createEmptyDraft = (department: Department | "" = ""): BasicAnnouncementDraft => ({ department, title: "", audiences: [], content: "", attachments: [], pdfAttachments: [], importantEvents: emptyImportantEvents(), deadlines: emptyDeadlines(), links: [] });
