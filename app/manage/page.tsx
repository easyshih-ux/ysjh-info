...
export default function ManagePage() {
  ...
  const addFollow = async () => {
    ...
    try {
      ...
      setItems(current => current.map(item => item.id === followTarget.id ? { ...item, followUps: [...item.followUps, followUp] } : item));
